...
public class VuforiaPhone {
    ...
    // robot pose relative to the center of the field
    public void getRobotFieldPose(){
        ...
        for (VuforiaTrackable trackable : allTrackables) {
            if (((VuforiaTrackableDefaultListener)trackable.getListener()).isVisible()) {
                ...
                OpenGLMatrix robotLocationTransform2 = ((VuforiaTrackableDefaultListener)trackable.getListener()).getPose();
    ...
    //relative pose to the skystone
    public VectorF getSkystoneTranslation(){
        targetVisible = false;
        VuforiaTrackableDefaultListener stoneDetector = ((VuforiaTrackableDefaultListener)allTrackables.get(0).getListener());

        if(stoneDetector.isVisible()){
            targetVisible = true;

            OpenGLMatrix robotLocationTransform = stoneDetector.getUpdatedRobotLocation();
            if (robotLocationTransform != null) {
                lastLocation = robotLocationTransform;
            }
